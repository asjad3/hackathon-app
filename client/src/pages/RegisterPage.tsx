...
export default function RegisterPage() {
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: "Save your credentials and backup codes securely.",
            });
        } catch (err) {
    ...
    if (
        ...
        credentials.backupCodes.length > 0
    ) {
        return (
            <BackupCodesDisplay
        ...
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
            <Card className="w-full max-w-md border-border/50 shadow-2xl">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Register with your NUST university email. Your identity
                        stays private.
                    </CardDescription>
                </CardHeader>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Accepted: @seecs.edu.pk, @nbs.nust.edu.pk,
                                    @smme.nust.edu.pk, @scme.nust.edu.pk,
                                    @s3h.nust.edu.pk, and other NUST departments
                                </p>
                            </div>
                        ...
                        <div className="space-y-4">
                            <Alert className="border-green-500/50 bg-green-500/10">
                                ...
                                <AlertDescription className="text-green-600 dark:text-green-400">
                                    Account created successfully! Save your
                                    credentials.
                                </AlertDescription>
                            </Alert>
